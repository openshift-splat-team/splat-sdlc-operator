...
| `full_sdlc` | End-to-end feature lifecycle: epic, enhancement doc, human approval, mirror repos from GitHub (Gitea only), fork repos, feature analysis, stories, staging PRs, code gen with pre-PR CI validation, PR monitors | `orchestrator` | `SDLCFeatureInput` | [full-sdlc.md](full-sdlc.md) |
